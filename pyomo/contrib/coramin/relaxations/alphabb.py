...
class AlphaBBRelaxationData(BaseRelaxationData):
    def __init__(self, component):
        ...
        self._xs: Optional[Tuple[VarData]] = None
        self._aux_var = None
        self._f_x_expr: Optional[NumericExpression] = None
        self._alphabb_rhs: Optional[NumericExpression] = None
    ...
    def get_rhs_expr(self) -> NumericExpression:
