...
def _build_pw_bilinear_relaxation(
...
@declare_custom_block(name='PWBilinearRelaxation')
class PWBilinearRelaxationData(BasePWRelaxationData):
    """
    A class for managing Bilinear relaxations of bilinear terms (aux_var = x1 * x2).
    """
