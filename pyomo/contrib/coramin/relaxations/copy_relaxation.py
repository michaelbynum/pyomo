from .bilinear import PWBilinearRelaxationData, PWBilinearRelaxation
...
def copy_relaxation_with_local_data(rel, old_var_to_new_var_map=None):
    ...
    if isinstance(rel, PWXSquaredRelaxationData):
    ...
    elif isinstance(rel, PWBilinearRelaxationData):
        ...
        new_aux_var = old_var_to_new_var_map[id(rel.get_aux_var())]
        new_rel = PWBilinearRelaxation(concrete=True)
        new_rel.set_input(
            x1=new_x1,
            x2=new_x2,
            aux_var=new_aux_var,
